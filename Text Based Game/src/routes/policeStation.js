...
import { gameState, delay, updateGameOver, typeWriter } from "../../game.js";
...
export async function confessionRoute() {
  ...
  if (playerConfessed === true) {
    ...
    await typeWriter(`The clerk’s voice is soft. Can I help you?`);
    await delay(5000);
    ...
    await typeWriter(`I killed them.`);
    await delay(5000);

    await typeWriter(`The world tilts for a second. The room goes silent.`);
    await delay(5000);

    await typeWriter(`My family, you whisper, barely audible.`);
    await delay(5000);
    ...
    await typeWriter(`You lower your head.`);
    await delay(5000);

    await typeWriter(`I need to turn myself in.`);
    await delay(5000);
    ...
    await typeWriter(`Hands where we can see them.`);
    await delay(5000);
    ...
    await typeWriter(`Step back, one of them says. You obey, feet dragging.`);
    await delay(5000);
    ...
    await typeWriter(`Tell us exactly what happened, the first officer says.`);
    await delay(5000);
    ...
    await typeWriter(`The officers exchange a glance.`);
    await delay(5000);
    ...
    await typeWriter(`Are they still in the house?`);
    await delay(5000);

    await typeWriter(`You nod, eyes burning.`);
    await delay(5000);
    ...
    await typeWriter(`They step away, speaking into radios, low and urgent.`);
    await delay(5000);
    ...
    await typeWriter(`You stare at the floor. You can’t lift your head.`);
